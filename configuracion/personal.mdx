---
title: "Agrega y gestiona el personal de tu negocio"
...
<Steps>
  ...
  <Step title="Inicia la invitación">
    ...
    <img src="/images/placeholder.png" alt="Botón Invitar profesional en la sección Equipo" />
  </Step>
  <Step title="Ingresa los datos del profesional">
    Escribe el nombre completo y la dirección de correo electrónico del profesional.
  </Step>
  ...
  <Step title="Envía la invitación">
    Haz clic en **Enviar invitación**. TimeNest enviará un correo al profesional con un link de activación.
  </Step>
